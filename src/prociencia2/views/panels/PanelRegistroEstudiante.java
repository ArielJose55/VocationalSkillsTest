...
public class PanelRegistroEstudiante extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTextFieldAño.setBackground(jTextFieldNombres.getBackground());
        jTextFieldAño.setFont(jTextFieldNombres.getFont());
        jTextFieldAño.setForeground(jTextFieldNombres.getForeground());
        ...
        jTextFieldAño.addKeyListener(new KeyListenerTad());
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jTextFieldAño, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jTextFieldDiaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextFieldDiaFocusGained
        if(jTextFieldDia.getText().compareTo("Día") == 0){
    ...
    private void jTextFieldAñoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextFieldAñoFocusGained
        if(jTextFieldAño.getText().compareTo("Año") == 0){
            jTextFieldAño.setText("");
            ((PJTextField)jTextFieldAño).setCalendar(true);
        }
    ...
    private void verificaFormulario(){
        jButtonEnviar.setEnabled(!(((PJTextField)jTextFieldNombres).fieldEmply()
                ||((PJTextField)jTextFieldDia).fieldEmply()||((PJTextField)jTextFieldMes).fieldEmply()||((PJTextField)jTextFieldAño).fieldEmply()));
    }
    ...
    private Persona getEstudianteFromFormulario() throws NumberFormatException, IndexOutOfBoundsException{
        ...
        calendar.set(Integer.parseInt(jTextFieldAño.getText()), Integer.parseInt(jTextFieldMes.getText())-1, Integer.parseInt(jTextFieldDia.getText()));
